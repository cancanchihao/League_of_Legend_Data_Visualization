<template>
  <div class="hero">
    ...
    >
      <v-img
        :src="
          'http://1.14.45.200:8080/hero/heroImg?heroName=' +
          props.heroData[0].name
        "
        :alt="props.heroData[0].name"
      ></v-img>
    </v-avatar>
  ...
  <div
    v-if="props.heroData[0].winCount === 0 && props.heroData[1].winCount === 0"
    class="no-matches"
  >
    该英雄间无对位情况
  </div>
