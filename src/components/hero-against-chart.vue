<template>
  <div class="hero">
    <v-avatar class="avatar1" color="grey-darken-1" size="48" style="cursor: pointer">
      <v-img :src="'http://1.14.45.200:8080/hero/heroImg?heroName=' +
  ...
  <div v-else>
    <item :line_name="'对位胜场'" :data1="props.heroData[0].winCount" :data2="props.heroData[1].winCount"
      :obj1="props.heroData[0].name" :obj2="props.heroData[1].name" :selectedItem="selectedItem" :color1="'#fce38a'"
      :color2="'#f38181'">
    </item>
    ...
    <item :line_name="'分均经济'" :data1="props.heroData[0].gold" :data2="props.heroData[1].gold"
      :obj1="props.heroData[0].name" :obj2="props.heroData[1].name" :selectedItem="selectedItem" :color1="'#fce38a'"
      :color2="'#f38181'">
    </item>
